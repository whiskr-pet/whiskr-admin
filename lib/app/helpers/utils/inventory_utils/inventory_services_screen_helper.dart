    ...
    await showDialog(
      ...
      builder: (context) {
        return Dialog(
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
          insetPadding: const EdgeInsets.symmetric(horizontal: 40, vertical: 24),
          child: ListenableProvider<WAServicesProvider>.value(
            value: provider,
            child: Container(
              width: 400,
              decoration: BoxDecoration(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Are you sure you want to delete $serviceOfferedName?',
                    textAlign: TextAlign.center,
                    style: theme.textTheme.bodyMedium?.copyWith(color: theme.textTheme.bodyMedium?.color?.withValues(alpha: 0.7)),
                  ),
                  const SizedBox(height: 28),
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: CommonButton(
                          onPressed: () async => await ServiceOfferedActionUtils.onDeleteServiceOffered(context, provider, serviceOfferedID, serviceOfferedName),
                          buttonTitle: 'Delete',
                          buttonType: PPButtonType.web,
                          style: ButtonStyle(backgroundColor: WidgetStatePropertyAll<Color>(ColorHelper.red500.color)),
                          showBorder: false,
