...
class InventoryServicesHelper {
  Future<void> showDeleteDialog(BuildContext context, String productID, String productName) async {
    ...
    final provider = context.read<WAInventoryServicesProvider>();
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(color: ColorHelper.blue300.color.withOpacity(0.15), shape: BoxShape.circle),
