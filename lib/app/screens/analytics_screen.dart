          ...
          PopupMenuButton<String>(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [const Icon(Icons.calendar_today, size: 16), const SizedBox(width: 4), Text(_getTimeRangeText())],
              ),
            ),
          ),
        ],
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: ColorHelper.blue500.color.withOpacity(0.1), borderRadius: BorderRadius.circular(8)),
                child: Row(
                  children: [
                    Icon(Icons.info_outline, color: ColorHelper.blue500.color, size: 16),
                    const SizedBox(width: 8),
                    const Expanded(child: Text('Demo Mode: Click on any card to see detailed analytics')),
                  ],
                ),
              ),
                  ...
                  return GridView.count(
                    ...
                    children: [
                      _buildClickableStatCard(
                        ...
                        Icons.schedule,
                        ColorHelper.yellow500.color,
                        () => _showOrderStatusDetails('pending', orderProvider),
                      ),
                      _buildClickableStatCard(
                        'Confirmed',
                        ...
                        Icons.check_circle,
                        ColorHelper.blue500.color,
                        () => _showOrderStatusDetails('confirmed', orderProvider),
                      ),
                      _buildClickableStatCard(
                        'Processing',
                        ...
                        Icons.build,
                        ColorHelper.blue500.color,
                        () => _showOrderStatusDetails('processing', orderProvider),
                      ),
                      _buildClickableStatCard(
                        'Delivered',
                        ...
                        Icons.done_all,
                        ColorHelper.green500.color,
                        () => _showOrderStatusDetails('delivered', orderProvider),
                      ),
                    ],
                  );
                },
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(color: ColorHelper.blue500.color.withOpacity(0.8), borderRadius: BorderRadius.circular(4)),
                  ),
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                leading: CircleAvatar(
                  backgroundColor: ColorHelper.blue500.color.withOpacity(0.1),
                  child: Text(
                    '${index + 1}',
                    style: TextStyle(color: ColorHelper.blue500.color, fontWeight: FontWeight.bold),
                  ),
                ),
                ...
                trailing: Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.bold, color: ColorHelper.green500.color),
                ),
