...
import 'package:whiskr_admin_panel/app/screens/dashboard_screen/drawer/web_drawer.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text('Here\'s what\'s happening with your pet shop today.', style: Theme.of(context).textTheme.bodyLarge?.copyWith()),
                ...
                return GridView.count(
                  ...
                  children: [
                    ...
                    DashboardStatsCard(
                      ...
                      color: ColorHelper.green500.color,
            ...
            Row(
              ...
              children: [
                ...
                TextButton(onPressed: () => _onItemTapped(2), child: const Text('View All')),
              ],
            ),
            const SizedBox(height: 12),
