...
class _InventoryScreenState extends State<InventoryScreen> {
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Text('Demo Mode: Click on any product to edit or use quick actions')),
                ElevatedButton.icon(
          ...
          Consumer<ProductProvider>(
            builder: (context, productProvider, child) {
              return Container(
                ...
                child: Row(
                  children: [
                    _buildQuickStat('Total', productProvider.products.length.toString(), ColorHelper.blue500.color),
                    const SizedBox(width: 12),
                    _buildQuickStat('Low Stock', productProvider.lowStockProducts.length.toString(), ColorHelper.yellow500.color),
                    const SizedBox(width: 12),
                    _buildQuickStat('Out of Stock', productProvider.outOfStockProducts.length.toString(), ColorHelper.red500.color),
                  ],
                ),
              );
            },
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: FilterChip(
                        ...
                        selectedColor: ColorHelper.blue500.color.withOpacity(0.2),
                        checkmarkColor: ColorHelper.blue500.color,
            ...
            onPressed: () async {
              ...
              if (success && mounted) {
                ScaffoldMessenger.of(
                  context,
                ).showSnackBar(SnackBar(content: Text('Product deleted successfully'), backgroundColor: ColorHelper.green500.color));
              }
            },
            style: ElevatedButton.styleFrom(backgroundColor: ColorHelper.red500.color),
  ...
  void _sortProducts(String sortType) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Sorting by $sortType'), backgroundColor: ColorHelper.blue500.color));
  }
  ...
  void _createDemoProduct() async {
    ...
    if (success && mounted) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: const Text('Demo product created successfully!'), backgroundColor: ColorHelper.green500.color));
    }
  }
}
